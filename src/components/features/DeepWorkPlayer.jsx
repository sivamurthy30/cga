        ...
        {open && (
          <motion.div initial={{ opacity:0, y:20, scale:0.95 }} animate={{ opacity:1, y:0, scale:1 }}
            ...
            <div style={s.volumeRow}>
              ...
              <span style={{ ...s.volLabel, minWidth:28, textAlign:'right' }}>{Math.round(volume * 100)}%</span>
            </div>
...
const s = {
  ...
  closeBtn: { background:'none', border:'none', color:'var(--text-muted)', cursor:'pointer', fontSize:13, lineHeight:1 },
  ...
  trackBtn: {
    ...
    fontSize:12, textAlign:'left', transition:'all 0.15s', outline:'none',
  },
  trackActive: { background:'rgba(245,158,11,0.1)', color:'var(--accent-amber)', borderColor:'rgba(245,158,11,0.4)' },
  controls: { display:'flex', justifyContent:'center', alignItems:'center', gap:14, padding:'10px 0 6px' },
  ctrlBtn: { background:'none', border:'none', color:'var(--text-secondary)', fontSize:16, cursor:'pointer', padding:'4px 6px' },
  playBtn: {
    width:42, height:42, borderRadius:'50%',
    background:'var(--accent-amber)', border:'none', fontSize:16, cursor:'pointer',
    display:'flex', alignItems:'center', justifyContent:'center', color:'#000',
    boxShadow:'0 3px 10px rgba(245,158,11,0.3)',
  },
  volumeRow: { display:'flex', alignItems:'center', gap:8, padding:'0 14px 10px' },
  volLabel: { fontSize:11, color:'var(--text-muted)', userSelect:'none' },
  slider: { flex:1, accentColor:'var(--accent-amber)', height:4 },
